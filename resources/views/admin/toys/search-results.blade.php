...
.admin-navbar a {
    color: white;
    margin: 0 15px; /* Adjusted margin for more spacing */
...
.toys-image {
    width: 100px; /* Adjusted to match the size from the first code */
    height: 100px; /* Adjusted to match the size from the first code */
    object-fit: cover;
    border-radius: 5px;
}
...
.user-info {
    ...
    color: white;
    position: absolute;
    top: 15px; /* Increased spacing from top to match the first code */
    right: 15px; /* Increased spacing from right to match the first code */
}
...
.search-form {
    display: flex;
    align-items: center;
    margin: 20px 0; /* Adjusted margin to match the first code */
}
...
/* Background */
body {
    background-color: #ecf0f1; /* Same background color as the first code */
}
    ...
    <div class="container mt-4">
        ...
        <table class="table table-hover table-striped text-center fade-in">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6">No toys items found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
